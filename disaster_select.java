...
public class disaster_select extends AppCompatActivity {
    ...
    CompoundButton arg_second = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout temp = (LinearLayout) findViewById(R.id.temp);
        ScrollView temp_scroll = (ScrollView) findViewById(R.id.temp_scroll);
        ...
        for (i = 1; i < NUM_WEATHER; i++) {
            ...
            button_weather[i].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
                public void onCheckedChanged(CompoundButton arg0, boolean ischecked){
                    ...
                    for (int j=0;j<checkcount_second;j++){
                        TextView tmp = new TextView(getApplicationContext());
                        tmp.setText(disaster_list.get(j) + " " + checkcount_second);
                        temp.addView(tmp);
                    }
                }
            });
